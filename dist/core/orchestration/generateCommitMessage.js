...
const textGenerationService_1 = require("../providers/textGenerationService");
async function generateCommitMessage(context, hint) {
    try {
        const result = await vscode.window.withProgress({
            location: vscode.ProgressLocation.Notification,
            title: 'Commit Muse',
            cancellable: false,
        }, async () => (0, textGenerationService_1.generateAndWriteCommitMessage)(context, hint));
        if (result.truncated) {
